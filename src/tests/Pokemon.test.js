...
describe('Testes do componente <Pokemon.js />', () => {
  ...
  test('Se o card do Pokémon contém um link de navegação para exibir detalhes do Pokémon',
    () => {
      renderWithRouter(<App />);
  ...
  test('se ao clicar no link de navegação do Pokémon, é redirecionado da aplicação',
    () => {
